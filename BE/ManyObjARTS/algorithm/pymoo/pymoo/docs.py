...
algorithms = {
    ...
    "sampling": """
                :class:`~pymoo.pymoo.core.sampling.Sampling`, :class:`~pymoo.pymoo.core.population.Population`, :obj:`numpy.array`
                    ...
                    optimization algorithm. Here, you have three different options by passing
                        ...
                        (i) A :class:`~pymoo.pymoo.core.sampling.Sampling` implementation which is an implementation of a 
                        random sampling method. 

                        (ii) A :class:`~pymoo.pymoo.core.population.Population` object containing the variables to
    ...
    "selection": """:class:`~pymoo.pymoo.core.selection.Selection`
                    ...
                    pressure, ... 
                    """,
    "crossover": """:class:`~pymoo.pymoo.core.crossover.Crossover`
    ...
    "mutation": """:class:`~pymoo.pymoo.core.mutation.Mutation`
    ...
    "survival": """:class:`~pymoo.pymoo.core.survival.Survival`
